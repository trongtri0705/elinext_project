...
<ul class="breadcrumb">
    ...
    <li>
        <a href="{{url('admin/team/leader')}}">{{$title}}</a>
    </li>
    <li class="active">
        @if (isset($staff))
        Edit
...
<!-- ./ tabs -->
@if (isset($staff))
{!! Form::model($staff, array('url' => URL::to('admin/create-leader') . '/' . $staff->id, 'method' => 'put','id'=>'fupload', 'class' => 'bf', 'files'=> true)) !!}
@else
{!! Form::open(array('url' => URL::to('admin/create-leader'), 'method' => 'post', 'class' => 'bf','id'=>'fupload', 'files'=> true)) !!}
@endif
